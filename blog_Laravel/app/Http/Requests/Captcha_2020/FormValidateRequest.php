<?php
//used for validation form submit, used after Captcha images check
namespace App\Http\Requests\Captcha_2020;
...
class FormValidateRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
			...
			'hidden-captcha-array'     => ['required',  'string', 'min:8'],                                //Form field containing user's selcted captcha images
