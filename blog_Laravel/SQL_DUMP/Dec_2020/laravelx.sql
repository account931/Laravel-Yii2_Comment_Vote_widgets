...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Дек 22 2020 г., 20:38
...
(2, 'Dima', 'dimmm931@gmail.com', '$2y$10$P05BZocg4IQ9/.vlLmBN5uRRdTbL/TOWJ2b00vuQNDwltD/u7dyzi', NULL, NULL, NULL),
...
--
ALTER TABLE `wpress_blog_post`
  MODIFY `wpBlog_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=145;
