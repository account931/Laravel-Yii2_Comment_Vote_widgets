...
class Wpress_blog_post_Seeder extends Seeder {
  ...
  public function run()
  {
    ...
    DB::table('wpress_blog_post')->insert(['wpBlog_title' => 'Hygge', 'wpBlog_text' => 'Hygge is a Danish and Norwegian word for a mood of coziness and comfortable conviviality with feelings of wellness and contentment. As a cultural category with its sets of associated practices hygge has more or less the same meanings in Danish and Norwegian, but the notion is more central in Denmark than in Norway. The emphasis on hygge as a core part of Danish culture is a recent phenomenon, dating to the late 20th century.', 'wpBlog_author' => 2, 'wpBlog_category' =>2 ]);
