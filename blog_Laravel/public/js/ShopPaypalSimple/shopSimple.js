...
$(document).ready(function(){
   ...
   //                                                                                     ** 
    ...
    $('.button-plus').on('click', function(){ 
		...
		var numProduct = Number($(this).closest('div').next().find('input:eq(0)').val()); //gets current input quantity
		
		$(this).closest('div').next().find('input:eq(0)').val(Number(numProduct) + 1); //html new value++
    ...
    $('.button-minus').on('click', function(){
		var numProduct = Number($(this).closest('div').prev().find('input:eq(0)').val()); //gets current input quantity
		...
		$(this).closest('div').prev().find('input:eq(0)').val(numProduct - 1); //html new value--
