...
//START AJAX. On Click sends ajax to change user RBAC ROLE. Sends to /site/ajax-rbac-insert-update
    //$URL = "localhost" . Yii::$app->request->baseUrl . "/site/ajax-rbac-insert-update";   //WORKING,  gets the url to send ajax, defining it in  $ajax causes routing to 404, Not found, as the url address does not render correctly
    $URL = "http://localhost/laravel+Yii2_widgets/Yii2_comment_widget/frontend/web/index.php?r=site/ajax-rbac-insert-update";
